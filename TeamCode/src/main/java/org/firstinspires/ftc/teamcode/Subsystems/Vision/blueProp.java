...
public class blueProp extends OpenCvPipeline {

    Telemetry telemetry;

    public blueProp(Telemetry t) {
        telemetry = t;
    ...
    Scalar blue = new Scalar(255, 0, 0); // define what the color of the rectangle outline is that appears on the output (red)
    ...
    public Mat processFrame(Mat input) {
        ...
        Scalar lowBlueBound = new Scalar(100, 100, 20);
        Scalar highBlueBound = new Scalar(120, 255, 255);
